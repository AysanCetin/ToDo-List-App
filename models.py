...
# TODO lar ile ilgili bir sınıf oluşturup içerisinde belirli tanımlamalar yapalım...
...
class ToDos(models.Model):
    ...
    # Oluşturduğumuz TODO bitti mi bitmedi mi görebilmek için BooleanField kullanacaz...
    # yeni oluşturulduğu için "default = False" olur, yani bitmemiş olur...
    finished = models.BooleanField(default = False)

    # TODO nun ne zaman oluşturulacağını belirlemek için DateTimeField kullanacaz.
...
# Şimdi bu todo listemiz admin sayfasında görülecek. O yüzden admin.py ye gidip:
  # from.models import ToDos ---> deyip bunu admin sayfasına kabul ettirmek için de --->>> admin.site.register(ToDos) deriz.


# todo eklediğimizde "ToDos object (1)" şeklinde görülür. Ancak biz başlıklar görünsün istiyoruz. Bunun için:
